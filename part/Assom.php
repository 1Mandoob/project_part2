...
<body>
    ...
    const foods = [
    new food("Meet Burger", 1, "imgs/food_content/Asoom/burger.jpg"),
    new food("Double Meet Burger", 1.5, "imgs/food_content/Asoom/duburger.jpg"),
    new food("Fries", 1.5, "imgs/food_content/Asoom/fires.jpg"),
    new food("Meet Mashakek!!", 0.2, "imgs/food_content/Asoom/masha.jpg")
];
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="row">
                        <div class="col-md-4">
                    <div class="card-imgs"> <img  src="imgs/food_content/Asoom/asoom.jpg" alt=".."  height="400px" width="400px"></div>
                    </div>
                         <div class="col-md-6">
                    <div class="card-title"> 
                        <h1 class="display-1" style="padding-top: 100px; margin-left: 50px;">Assom Burger</h1>
            ...
            <div class="row g-2">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-center">
                            <img src="imgs/food_content/Asoom/burger.jpg" class="card-img-center img-fluid"
                                style="width: 200px; height: 200px;" alt="...">
                        </div>

                        <div class="card-body">
                            <h5 class="card-title"> Meet Burger</h5>
                            <p class="card-text">enjoy and test our Meet Burger with its delicious Sauces </p>
                            <h6>Only for: 1 OMR</h6>
                            <button type="button" class="btn btn-primary" value="1" onclick="addToCart(' Meet Burger',1)">Add to cart</button>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-center">
                            <img src="imgs/food_content/Asoom/duburger.jpg" class="card-img-center img-fluid"
                                style="width: 200px; height: 200px;" alt="...">
                        </div>

                        <div class="card-body">
                            <h5 class="card-title">Double Meet Burger</h5>
                            <p class="card-text">enjoy and test our Double Meet Burger with its delicious Sauces </p>
                            <h6>Only for: 1.5 OMR</h6>
                            <button type="button" class="btn btn-primary" value="1.5" onclick="addToCart('Double Meet Burger',1.5)">Add to cart</button>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-center">
                            <img src="imgs/food_content/Asoom/fires.jpg" class="card-img-center img-fluid"
                                style="width: 200px; height: 200px;" alt="...">
                        </div>

                        <div class="card-body">
                            <h5 class="card-title">Fries</h5>
                            <p class="card-text">taste our spicial Sauces in the fries</p>
                            <h6>Only for: 1.5 OMR</h6>
                            <button type="button" class="btn btn-primary" value="2.5" onclick="addToCart('Fries',1.5)">Add to cart</button>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-center">
                            <img src="imgs/food_content/Asoom/masha.jpg" class="card-img-center img-fluid"
                                style="width: 200px; height: 200px;" alt="...">
                        </div>

                        <div class="card-body">
                            <h5 class="card-title">Meet Mashakek!!</h5>
                            <p class="card-text">Sometimes the picture discipes many words </p>
                            <h6>Only for: 0.2 OMR per One</h6>
                            <button type="button" class="btn btn-primary" value="2.5" onclick="addToCart('Meet Mashakek',0.2)">Add to cart</button>
