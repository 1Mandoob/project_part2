...
<body>
    ...
    <div class="container">
        ...
        <table id="bill-table">
            ...
            <tbody id="bill-table-body">
                <?php foreach ($billItems as $item): ?>
                    <tr>
                        <td><?php echo $item['name']; ?></td> <!-- Assuming 'name' is the column name for item name -->
                        <td><?php echo $item['price']; ?></td> <!-- Assuming 'price' is the column name for item price -->
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>

        <p>Total Price: <?php echo $totalPrice; ?> OMR</p>
        ...
        <p>Discounted Price: <?php echo $discountedPrice; ?> OMR</p>
