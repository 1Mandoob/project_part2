...
<body>
    ...
    const foods = [
    new food("Chocolate Cake", 2.5, "imgs/food_content/bun/cake.jpg"),
    new food("Cheese Cake", 1.5, "imgs/food_content/bun/cheese.jpeg"),
    new food("Donate", 3.5, "imgs/food_content/bun/donate.jpg"),
    new food("Ice cream", 0.3, "imgs/food_content/bun/ice.webp"),
    new food("Whaffle", 1, "imgs/food_content/bun/wha.jpeg"),
    new food("SanSpastian", 1.5, "imgs/food_content/bun/sans.jpg")
];
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="row">
                        <div class="col-md-4">
                    <div class="card-imgs"> <img  src="imgs/food_content/bun/bun_truck.jpg" alt=".."  height="400px" width="400px"></div>
                    </div>
                         <div class="col-md-6">
                    <div class="card-title"> 
                        <h1 class="display-1" style="padding-top: 100px; margin-left: 50px;">Bun truck</h1>
            ...
            <div class="row g-2">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-center">
                            <img src="imgs/food_content/bun/cake.jpg" class="card-img-center img-fluid"
                                style="width: 200px; height: 200px;" alt="...">
                        </div>

                        <div class="card-body">
                            <h5 class="card-title">Chocolate Cake</h5>
                            <p class="card-text">Very sweety cake, espicially when it coverd by Chocolate Sauce</p>
                            <h6>Only for: 2.5 OMR</h6>
                            <button type="button" class="btn btn-primary" value="2.5" onclick="addToCart('chocolate cake',2.5)">Add to cart</button>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-center">
                            <img src="imgs/food_content/bun/cheese.jpeg" class="card-img-center img-fluid"
                                style="width: 200px; height: 200px;" alt="...">
                        </div>

                        <div class="card-body">
                            <h5 class="card-title">Cheese Cake</h5>
                            <p class="card-text">Taste it and judge it</p>
                            <h6>Only for: 1.5 OMR</h6>
                            <button type="button" class="btn btn-primary" value="2.5" onclick="addToCart('cheese cake',1.5)">Add to cart</button>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-center">
                            <img src="imgs/food_content/bun/donate.jpg" class="card-img-center img-fluid"
                                style="width: 200px; height: 200px;" alt="...">
                        </div>

                        <div class="card-body">
                            <h5 class="card-title">Donate</h5>
                            <p class="card-text">Taste all Flavours</p>
                            <h6>Only for: 3.5 OMR</h6>
                            <button type="button" class="btn btn-primary" value="2.5" onclick="addToCart('Donate',3.5)">Add to cart</button>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-center">
                            <img src="imgs/food_content/bun/ice.webp" class="card-img-center img-fluid"
                                style="width: 200px; height: 200px;" alt="...">
                        </div>

                        <div class="card-body">
                            <h5 class="card-title">Ice cream</h5>
                            <p class="card-text">Choose your favourit flavour</p>
                            <h6>Only for: 0.3 OMR per One</h6>
                            <button type="button" class="btn btn-primary" value="2.5" onclick="addToCart('Ice cream',0.3)">Add to cart</button>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-center">
                            <img src="imgs/food_content/bun/wha.jpeg" class="card-img-center img-fluid"
                                style="width: 200px; height: 200px;" alt="...">
                        </div>

                        <div class="card-body">
                            <h5 class="card-title">Whaffle</h5>
                            <p class="card-text">With the Orivginal honey</p>
                            <h6>Only for: 1 OMR</h6>
                            <button type="button" class="btn btn-primary" value="2.5" onclick="addToCart('Whaffle',1)">Add to cart</button>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-center">
                            <img src="imgs/food_content/bun/sans.jpg" class="card-img-center img-fluid"
                                style="width: 200px; height: 200px;" alt="...">
                        </div>

                        <div class="card-body">
                            <h5 class="card-title">SanSpastian</h5>
                            <p class="card-text"></p>
                            <h6>Only for:1.5 OMR per One</h6>
                            <button type="button" class="btn btn-primary" value="2.5" onclick="addToCart('SanSpastian',1.5)">Add to cart</button>
